...
describe ProcesadorDeMarcador do
  ...
  it 'El procesador recibe un tag con valor aleatorio sin valor en el template' do
  ...
  it 'El procesador recibe un tag con valor aleatorio con valor en el template' do
